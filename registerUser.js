...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    return fabric_ca_client.register({enrollmentID: 'user10', affiliation: 'org1.department1',role: 'client'}, admin_user);
}).then((secret) => {
    // next we need to enroll the user with CA server
    console.log('Successfully registered user1 - secret:'+ secret);

    return fabric_ca_client.enroll({enrollmentID: 'user10', enrollmentSecret: secret});
}).then((enrollment) => {
